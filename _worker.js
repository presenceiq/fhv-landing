...
const GPALM_TAIL = `
  ...
  <section class="section src-county">
    ...
    <p class="note">What a buyer would pay in property tax. A purchase resets the taxable value to about 89% of the price, so the seller's current bill doesn't carry over. At Grand Palm's typical single-family resale price of <strong>$495,000</strong>, yearly property tax would be about <strong>$5,055</strong> without a homestead exemption, or about <strong>$4,626</strong> for a buyer who makes it their primary home, before the CDD and other non-ad valorem charges. Grand Palm is taxed as unincorporated Sarasota County. It isn't part of the West Villages Improvement District that covers most of Wellen Park; it has its own, the Blackburn Creek CDD. On one Grand Palm home's 2025 tax bill that came to $985.72, and with county fire rescue, solid waste and stormwater, the charges on top of the property tax totaled $1,697.46 for the year. Amounts vary by lot and phase. <a href="https://floridahomevalueai.com/property-tax-calculator">Work out any price in the tax calculator &rarr;</a></p>
